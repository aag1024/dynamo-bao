...
class TestBinary extends BaseModel {
...
describe('Binary Field Tests', () => {
  ...
  test('should store Buffer and retrieve as Uint8Array', async () => {
    ...
    expect(Buffer.from(fetchedBinary.requiredData).toString()).toBe('Required Data');
  });
  ...
  test('should accept both Buffer and Uint8Array for writes', async () => {
    ...
    expect(Buffer.from(fetchedUint8Array.data).toString()).toBe('Uint8Array Data');
  });
}); 